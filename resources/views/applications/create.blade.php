                    ...
                    <div class="lg:col-span-2 bg-gray-50 p-8 lg:p-10 border-r border-gray-200">
                        ...
                        <div class="space-y-4 mb-8">
                            ...
                            <div class="flex items-start">
                                ...
                                <p class="text-gray-700 leading-relaxed">
                                    <span class="font-semibold">Paid training provided</span> — Learn everything you need to know before each election
                                </p>
                            </div>
                        ...
                        <div class="bg-white border-2 border-blue-200 rounded-lg p-6">
                            ...
                            <ol class="space-y-3 text-sm text-gray-700">
                                <li class="flex items-start">
                                    <span class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-blue-100 text-blue-700 font-semibold mr-3 flex-shrink-0">1</span>
                                    <span>Complete the registration form</span>
                                </li>
                                <li class="flex items-start">
                                    <span class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-blue-100 text-blue-700 font-semibold mr-3 flex-shrink-0">2</span>
                                    <span>Confirm your email address</span>
                                </li>
                                <li class="flex items-start">
                                    <span class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-blue-100 text-blue-700 font-semibold mr-3 flex-shrink-0">3</span>
